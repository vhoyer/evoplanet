...
namespace Jogo._7._2.FuturoRuim
{
    public partial class FuturoR : Form
    {
        ...
        {
            FuturoRMap abrir = new FuturoRMap(Comida, Dinheiro, atrN[1], atrN[0], nick);
            abrir.ShowDialog();
            ...
            if ((atrN[2] >= 7) && (Conquista[0] == "0"))
            {
                ...
                MessageBox.Show("Aparentimente, você reencontrou todos perdidos daquele laboratório!", "Conquista desbloqueada! - Herói", MessageBoxButtons.OK);
                Conquista[0] = "1";
            ...
            if ((atrN[3] >= 7) && (Conquista[1] == "0"))
            {
                ...
                MessageBox.Show("Isso é mesmo verdade? Uma planta de melância!", "Conquista desbloqueada! - Reflorestamento", MessageBoxButtons.OK);
                Conquista[1] = "1";
            ...
            if ((atrN[4] >= 7) && (Conquista[2] == "0"))
            {
                ...
                MessageBox.Show("Os orfãos estão felizes!", "Conquista desbloqueada! - Criador", MessageBoxButtons.OK);
                Conquista[2] = "1";
                if (x[2] == "0") x[2] = "1";
            }
            ...
            if (atrN[0] <= 0)
            {
                ...
                player.Stop();
                Jogo.Sperm Chance = new Jogo.Sperm(6, nick);
                Chance.Show();
                this.Close();
        ...
        private void salvarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            uso.RescreverLinha(3, nick, "9;" + x[1]);
        ...
        {
            player.Stop();
            MessageBox.Show("Aos poucos, a humanidade foi se reerguendo... Porém, isso foi um atraso na evolução do humano, então o planeta ficou estatico no requisito tecnologia...", "Bad End");
        ...
        {
            _7._1.FuturoBom.InstruFuturo x = new _1.FuturoBom.InstruFuturo();
            x.ShowDialog();
        }

        private void FuturoR_Load(object sender, EventArgs e)
        {
            player.PlayLooping();
        }
    }
