...
namespace musicPlayer
{
    public partial class MegaMarte : Form
    {
        ...
        const int danoLevado_m = 80, danoLevado_M = danoLevado_m + 40;
        Point respawnPoint;
        //
        // Inimigo
        //
        ...
        private void InitializeVariables()
        {
            ...
            //Fundo
            bgBmp = Jogo.Properties.Resources.Stage1;
            center = new Point(pnlMain.Size.Width / 2, pnlMain.Size.Height / 2);
            //som
            soundBoom = new SoundPlayer(Jogo.Properties.Resources.BOOMSom);
            soundBoom.Load();
            soundGrito = new SoundPlayer(Jogo.Properties.Resources.GritoSom);
            soundGrito.Load();
            soundTiro = new SoundPlayer(Jogo.Properties.Resources.ShotSom);
            soundTiro.Load();
            soundBlik = new SoundPlayer(Jogo.Properties.Resources.BlikSom);
            soundBlik.Load();
            soundHurt = new SoundPlayer(Jogo.Properties.Resources.HurtSom);
            soundHurt.Load();
        }
        ...
        private void Respawn()
        {
            ...
            if (lifes > 0)
            {
                ...
                isRight = true;
                isLeft = false;
                picHero.Image = Jogo.Properties.Resources.standRight;
        ...
        private void tmrDiiiie_Tick(object sender, EventArgs e)
        {
            ...
            if (aniDiiie == 1)
            {
                picHero.Image = Jogo.Properties.Resources.explode;
            }
            else if (aniDiiie == 90)
            {
                soundBoom.Stop();
        ...
        {
            Point pt = new Point(pic.Location.X + pic.Size.Width / 2 - Jogo.Properties.Resources.enemyStand.Size.Width / 2, pic.Location.Y - Jogo.Properties.Resources.enemyStand.Size.Height);
            ...
            picEnemy.Image = Jogo.Properties.Resources.enemyStand;
            picEnemy.Location = pt;
            picEnemy.Size = Jogo.Properties.Resources.enemyStand.Size;
            ...
            picPackage.Image = Jogo.Properties.Resources.Package1;
            picPackage.Size = Jogo.Properties.Resources.Package1.Size;
        ...
        private void tmrEnemy_Tick(object sender, EventArgs e)
        {
            ...
            if (iniAni == 6)
            {
                ...
                {
                    picEnemy.Image = Jogo.Properties.Resources.enemy1Left;
                }
                else
                {
                    picEnemy.Image = Jogo.Properties.Resources.enemy1Right;
                }
                ForShot = shotImp;
                picPackage.Visible = true;
            }
            if (iniAni == 10)
            {
                if (calculaDistancia() < 0)
                {
                    picEnemy.Image = Jogo.Properties.Resources.enemy2Left;
                }
                else
                {
                    picEnemy.Image = Jogo.Properties.Resources.enemy2Right;
                }
                tmrEnemyShot.Start();
            }
            if (iniAni == 13)
        ...
        private void tmrHurt_Tick(object sender, EventArgs e)
        {
            ...
            if (isLeft)
            {
                picHero.Image = Jogo.Properties.Resources.hurtLeft;
                picHero.Location = new Point(picHero.Location.X + movSpeed, picHero.Location.Y);
            }
            else if (isRight)
            {
                picHero.Image = Jogo.Properties.Resources.hurtRight;
                picHero.Location = new Point(picHero.Location.X - movSpeed, picHero.Location.Y);
            }
            ...
            if (picHero.Location.X >= whereToStop && isLeft)
            {
                tmrHurt.Stop();
                tmrInvi.Start();
                picHero.Image = Jogo.Properties.Resources.standLeft;
                isHurt = false;
                canShot = true;
            }
        ...
        private void tmrMov_Tick(object sender, EventArgs e)
        {
            ...
            if (isRight)
            {
                ...
                {
                    case 1:
                        picHero.Image = Jogo.Properties.Resources.run1Right;
                        break;
                    case 2:
                        picHero.Image = Jogo.Properties.Resources.run2Right;
                        ani = 0;
                        break;
                }
            }
            else if (isLeft)
            {
                ...
                {
                    case 1:
                        picHero.Image = Jogo.Properties.Resources.run1Left;
                        break;
                    case 2:
                        picHero.Image = Jogo.Properties.Resources.run2Left;
                        ani = 0;
                        break;
                }
            }
        ...
        private void Form2_KeyUp(object sender, KeyEventArgs e)
        {
            if (!tmrDiiiie.Enabled)
            {
                ...
                if (!inJump)
                {
                    if (isRight) picHero.Image = Jogo.Properties.Resources.standRight;
                    else if (isLeft) picHero.Image = Jogo.Properties.Resources.standLeft;
                } 
            }
        }
        ...
        private void tmrShot_Tick(object sender, EventArgs e)
        {
            if (canShot)
            {
                if (frm == 0)
                {
                    ...
                    if (isLeft)
                    {
                        picHero.Image = Jogo.Properties.Resources.shotLeft;
                    }
                    if (isRight)
                    {
                        picHero.Image = Jogo.Properties.Resources.shotRight;
                    }
                    canShot = false;
        ...
        private void LeftOrRight()
        {
            if (isLeft)
            {
                ...
                this.Bullet1.Image = Jogo.Properties.Resources.bulletLeft;
            }
            else if (isRight)
            {
                Bullet1.Location = new Point(picHero.Location.X + picHero.Size.Width, picHero.Location.Y + 59);
                this.Bullet1.Image = Jogo.Properties.Resources.bulletRight;
            }
        }
        ...
        private void tmrJump_Tick(object sender, EventArgs e)
        {
            ...
            if (!tmrShot.Enabled && !tmrHurt.Enabled)
            {
                if (isLeft)
                {
                    picHero.Image = Jogo.Properties.Resources.jumpLeft;
                }
                else if (isRight)
                {
                    picHero.Image = Jogo.Properties.Resources.jumpRight;
                }
            }
