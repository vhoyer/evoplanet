...
namespace Jogo
{
    ...
    public partial class CSNewGame : Form
    {

        public CSNewGame(string nick)
        {
            InitializeComponent();
            this.nick = nick;
        }
        ...
        private void CSNewGame_Load(object sender, EventArgs e)
        {
            player.PlayLooping();
        }
        ...
        private void Exibir()
        {
            ...
            switch (Cena)
            {
                ...
                case 2:
                    ...
                    btnPrx.Text = "Começar";
                    break;
                case 3:  lblText3.Visible = false; pctrText3.Visible = false;
        ...
        {
            PreHistoria comecar = new PreHistoria(nick);
            player.Stop();
            comecar.Show();
            this.Close();
        }
